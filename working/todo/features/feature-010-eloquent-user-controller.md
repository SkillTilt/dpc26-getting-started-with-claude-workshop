# Feature #10: Replace raw DB queries in UserController with Eloquent

**Issue:** [#10](https://github.com/SkillTilt/dpc26-getting-started-with-claude-workshop/issues/10)
**Scope:** Small
**Status:** Open
