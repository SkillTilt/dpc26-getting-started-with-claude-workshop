# Race condition in BidController@store -- no transaction or row locking
...
High -- this can cause financial inconsistency in a bidding platform. Under real traffic with popular items approaching their deadline, this would be triggered regularly.
